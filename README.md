# 🔌 Conexão Evolution v2.0

Interface simplificada para conectar instâncias do WhatsApp via Evolution API.

## Funcionalidades
- 🔗 **Geração de Links Seguros**: Cria links de acesso rápido para clientes.
- 📱 **QR Code Dinâmico**: Exibe o QR code para conexão em tempo real.
- 🎨 **Design Moderno**: Interface limpa e intuitiva.
- ✂️ **Encurtador Integrado**: Suporte para TinyURL.
- 🔒 **Segurança**: Dados sensíveis (API Key) não são armazenados, apenas codificados na URL.

## Como Usar
1. Abra o arquivo `index.html` em um servidor web (local ou hospedado).
2. Insira a URL da API, API Key e Nome da Instância.
3. Gere o link e envie para o cliente.

## Requisitos
- Navegador moderno com suporte a JavaScript.
- Acesso à API Evolution (v2+).
